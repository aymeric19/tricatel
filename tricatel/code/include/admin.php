   ...
   <a class="btn btn-danger" href="deconnexion.php" role="button">Se déconnecter</a>
    ...
    <header id="baniere">
        <div class="hero-container">
            <img src="../assets/img/pizza_baniere.png" class="img w-100" alt="">
        </div>
        <h1 class="text-center">Administrateur </h1>
        <div class="button d-flex justify-content-center mb-3 ">
        <a class="btn btn-primary" href="plat_admin.php" role="button">Accéder aux articles</a>
        </div>
    </header>

    <div class="container">
    <h2 class="text-center my-4">Ajouter/Modifier</h2>
